...
export default function WhatWeStandFor() {
  return (
    <section className="py-16 bg-white">
      <h3 className="text-center text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-15">
        <span className="text-[#faa11b]">Empower your health,</span> Transform
        your life – Discover Remedius, a gateway to complete well-being with
        Telemedicine
      </h3>
      <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-10 items-center">
        {/* Left Content */}
        <div className="lg:w-1/2">
          <div className="inline-block px-4 py-1 mb-4 text-sm font-medium text-white bg-gradient-to-r from-[#faa11b] to-[#ff5e00] rounded-full">
            What we stand for
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-2 sm:p-4 shadow-sm mb-4">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4">
              <div className="bg-white rounded-lg p-2 sm:p-4 shadow text-center border-2 border-[#faa11b] relative overflow-hidden">
              ...
              <div className="bg-white rounded-lg p-2 sm:p-4 shadow text-center border-2 border-[#00b386] relative overflow-hidden">
        ...
        {/* Right Image */}
        <div className="lg:w-1/2 relative rounded-xl overflow-hidden shadow-md flex justify-center items-center">
          <Image
            src="/img/about.png"
            alt="Team Meeting"
            width={500}
