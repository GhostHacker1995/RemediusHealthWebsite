...
export default function RemediusFooter() {
  return (
    ...
    >
      ...
      <div className="py-12 px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/80">
            ...
            <li>
              <Link href="/pharmacy">Smart Pharmacy</Link>
            </li>
            <li>
              <Link href="/education">Health Education</Link>
            </li>
            <li>
        ...
        <div className="rounded-lg p-5  flex flex-col gap-3">
          ...
          <ul className="space-y-2 text-sm text-white/80">
            ...
            <li className="flex items-center gap-2">
              ...
              <span>Nasana, 400m off Jenina Stage, Ganda, Wakiso, Uganda</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      {/* Bottom Line */}
      <div className="border-t border-white/10 py-6 px-6 md:px-12 text-center text-sm text-white/60 flex justify-between items-center">
        <span>
